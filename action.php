...
if ($action == 'save') {
    $tpl = $_REQUEST['tpl'];
    $html_header = '<!DOCTYPE html><html><head lang="en"><meta charset="UTF-8"><title>Tdrag</title><link href="demo.css" type="text/css" rel="stylesheet"> <script type="text/javascript" src="JavaScript/LodopFuncs.js"> </script> <style> .boxList{ height: 387px; position: relative; width: 600px; background: url(/DP-Ticket/image/default.png) no-repeat center center;
		margin: 0px auto;} .title { cursor: move; } .item textarea { background-color: transparent; overflow:hidden; resize:none; } textarea { margin-left: 10px; } </style></head><body>';
    $foot = '</body></html>';
